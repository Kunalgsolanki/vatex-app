...
<div role="status" class="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700 ">
    ...
    <span class="sr-only">Loading...</span>
      ...
      <Carousel className="rounded-xl border-t-2 border-b-2">
  ...
  <div className="absolute inset-0 grid h-full w-full items-center bg-black/75">
    <div className="w-3/4 pl-12 md:w-2/4 md:pl-20 lg:pl-32">
      ...
      >
        ...
        We are ready to boom on our journey to space. We will keep you updated, so stay tuned!🚀
      </Typography>
  ...
  <div className="absolute inset-0 grid h-full w-full items-center bg-black/75">
    <div className="w-3/4 pl-12 md:w-2/4 md:pl-20 lg:pl-32">
      ...
      >
        ...
        That is the beauty of Rocket Science🚀
      </Typography>
      <div className="flex gap-2">
  ...
  <div className="absolute inset-0 grid h-full w-full items-end bg-black/75">
    <div className="w-3/4 pl-12 pb-12 md:w-2/4 md:pl-20 md:pb-20 lg:pl-32 lg:pb-32">
      ...
      >
        ...
        It was a blast and onto bigger things now. 🚀
      </Typography>
      <div className="flex gap-2">
