...
export default function SB() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="inline-flex w-full text-max-w-screen-xl md:text-max-w-screen-xl justify-center gap-x-1.5 rounded-md bg-black  px-3 py-2 font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-black">
